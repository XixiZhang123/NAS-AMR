...
args.save = 'PC-DARTS 20(6nodes,init_16,128)(k=4) qeval-{}-{}'.format(args.save, time.strftime("%Y%m%d-%H%M%S"))
...
def main():
  ...
  traindir = os.path.join(args.data, 'train20(2k)')
  validdir = os.path.join(args.data, 'val20(500)')
  ...
  for epoch in range(args.epochs):
    ...
    # logging.info('valid_loss %03d', valid_obj)
